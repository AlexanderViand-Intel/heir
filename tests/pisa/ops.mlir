...
func.func @test_pntt(%arg0 : tensor<8192xi32>) ->  tensor<8192xi32>  {
    ...
    %0 = pisa.pntt %arg0, %w {q = 2147483647 : i32, i = 0 : i32} : tensor<8192xi32>
  return %0 : tensor<8192xi32>
}
...
func.func @test_pintt(%arg0 : tensor<8192xi32>) ->  tensor<8192xi32>  {
    //TODO: figure out how to best handle the twiddle factors here...
    %w = arith.constant dense<42> : tensor<8192xi32>
    %0 = pisa.pintt %arg0, %w {q = 2147483647 : i32, i = 0 : i32} : tensor<8192xi32>
  return %0 : tensor<8192xi32>
}
...
func.func @test_invalid_tensor(%arg0 : tensor<1024xi32>, %arg1 : tensor<1024xi32>) ->  tensor<1024xi32> {
    // expected-error@below {{custom op 'pisa.padd' 'pisa.padd' op operand #0 must be tensor<8192xi32>, but got 'tensor<1024xi32>'}}
    %0 = pisa.padd %arg0, %arg1 {q = 2147483647 : i32, i = 0 : i32} : tensor<1024xi32>
...
func.func @test_invalid_modulus(%arg0 : tensor<8192xi32>, %arg1 : tensor<8192xi32>) ->  tensor<8192xi32> {
    // expected-error@below {{custom op 'pisa.padd' 'pisa.padd' op attribute 'q' failed to satisfy constraint: 32-bit signless integer attribute}}
    %0 = pisa.padd %arg0, %arg1 {q = 18446744073709551557, i = 0 : i32} : tensor<8192xi32>
  return %0 : tensor<8192xi32>
}
