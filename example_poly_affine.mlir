module {
  func.func @foo_poly(%arg0: tensor<2x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>, %arg1: tensor<2x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>) -> tensor<3x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>> {
    ...
    %10 = tensor.empty() : tensor<3x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>
    %11 = affine.for %arg2 = 0 to 3 iter_args(%arg3 = %10) -> (tensor<3x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>) {
      %extracted_10 = tensor.extract %from_elements[%arg2] : tensor<3x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>
      %extracted_11 = tensor.extract %from_elements_9[%arg2] : tensor<3x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>
      %12 = polynomial.sub %extracted_10, %extracted_11 : !polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>
      %inserted = tensor.insert %12 into %arg3[%arg2] : tensor<3x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>
      affine.yield %inserted : tensor<3x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>
    }
    return %11 : tensor<3x!polynomial.polynomial<ring = <coefficientType = i32, coefficientModuli = dense<[463187969, 679389209, 383838383]> : tensor<3xi32>, polynomialModulus = <1 + x**8192>>>>
  }
}
